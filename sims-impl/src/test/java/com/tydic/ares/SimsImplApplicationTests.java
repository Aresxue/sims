...
{
    private static final Logger LOGGER = LoggerFactory.getLogger(SimsImplApplicationTests.class);
...
//            {
//                int surNameIndex = random.nextInt(SUR_NAME.length);
//                int wordNameIndex = random.nextInt(WORD.length);
//                student.setStudentName(SUR_NAME[surNameIndex] + WORD[wordNameIndex]);
//
//                int age = random.nextInt(100);
//                student.setStudentAge(age);
//
//                int classId = random.nextInt(10);
//                student.setClassId(classId);
//
//                int sex = random.nextInt(2);
//                student.setStudentSex(sex == 0 ? "男" : "女");
//
//
//                demoMapper.addStudent(student);
//            }
//            LOGGER.info("执行时间为: {}ms", System.currentTimeMillis() - start);
//
//        }
...
//        }
//        demoMapper.addStudentBatch(studentList);
//        LOGGER.info("执行时间为: {}ms", System.currentTimeMillis() - start);
//    }
